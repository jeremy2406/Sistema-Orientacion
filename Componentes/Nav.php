...
<aside class="sidebar">
    ...
    <ul class="nav_list">
        ...
        <li class="nav-item"><a href="<?= BASE_URL ?>Extra/MANUAL DE CONVIVENCIA ESCOLAR DON BOSCO.pdf" target="_blank" data-tooltip="Manual de Convivencia"><i class="fa-solid fa-book"></i><span class="link_name">M. de Convivencia</span></a></li>
    </ul>
</aside>
